...
# General Auxiliary functions - not RL related
class CommonUtils:
    @staticmethod
    def build_pta_from_blackbox(blackboxProc: Process,
        ...
        samples = s_plus
        alphabet = blackbox.input_symbols
        pta = PTA(alphabet)
...
# Monte Carlo policy evaluation class
class RLUtility(object):
    ...
    @staticmethod
    # this function generates a single random episode from the blackbox, and returns it. In this context, "init_state"
    # and "final_state" are prefixes.
